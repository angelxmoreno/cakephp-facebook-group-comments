	...
	<div class="span9">
		...
		<table class="table">
			<tr>
				...
				<th><?php echo $this->BootstrapPaginator->sort('members_count');?></th>
				<th><?php echo $this->BootstrapPaginator->sort('icon');?></th>
				<th><?php echo $this->BootstrapPaginator->sort('admin_id');?></th>
		...
		<?php foreach ($groups as $group): ?>
			<tr>
				...
				<td><?php echo h($group['Group']['members_count']); ?>&nbsp;</td>
				<td><?php echo h($group['Group']['icon']); ?>&nbsp;</td>
				<td><?php echo h($group['Group']['admin_id']); ?>&nbsp;</td>
